  ...
  return (
    <div className="aboutMe">
      ...
      <p>
        ...
        Fredonia, Magna Cum Laude, with a Bachelor of Science in Communications
        and Media Studies. After school, I spent time in film and television
        while living in Atlanta, GA. After returning to Buffalo, I took over
        management of a local movie theatre, honing my leadership and business
        management skills.
      </p>
      <br></br>
      <p>
